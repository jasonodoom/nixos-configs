...
[![Garnix Build](https://img.shields.io/endpoint?url=https://garnix.io/api/v2/badges/jasonodoom/nixos-configs?output=framework-desktop.nixosConfigurations.perdurabo)](https://garnix.io/jasonodoom/nixos-configs)
[![Garnix Dev Shells](https://img.shields.io/endpoint?url=https://garnix.io/api/v2/badges/jasonodoom/nixos-configs?output=framework-desktop.devShells.x86_64-linux.go)](https://garnix.io/jasonodoom/nixos-configs)
